        ...
        <div className="p-4 md:p-6 space-y-8">
           <div className="card bg-light p-6">
                <h1 className="text-2xl font-bold text-gray-900 flex items-center gap-3">
                 ...
                 Select documents to view their forms, extracted text, and field data. Use the Document Inventory feature to identify required documents and track their processing status.
                </p>
            ...
            <div className="card bg-light p-6">
                {metadata && (
                    <div className="card bg-light p-6 mb-6 space-y-2">
                        <h1 className="text-xl font-bold text-gray-900 mb-4">Session Metadata</h1>
                ...
                <div className="card bg-light p-6 mb-6 space-y-2">
                    <div className="flex flex-wrap gap-4">
                        <h1 className="text-xl font-bold text-gray-900 w-full mb-4">Processed Documents</h1>
                        {documents.map((doc, index) => (
                            ...
                            >
                                <p className="font-semibold text-blue-800" style={{textTransform:"capitalize"}}>
                ...
                {expandedDoc && (
                    <div className="card bg-light p-6  space-y-2">
                        <h1 className="text-xl font-bold mb-4 text-gray-900 mb-6">
                            Forms for {" "}
                            {documents.find((d) => d.Id === expandedDoc)?.DocumentName || expandedDoc}
                        </h1>
                        ...
                        {activeFormId && (
                            <div
                                className=" bg-light p-6 mb-6 space-y-2 mt-8"
                            ...
                            >
                                ...
                                <div className="mb-8">
                                    <button
                                        ...
                                        className="px-4 py-2 bg-blue-100 text-blue-800 rounded shadow hover:bg-blue-200 flex items-center gap-2 mb-8 mt-8"
                                    >
                                        {inventoryLoading && (
                                            <span className="w-4 h-4 border-2 border-blue-800 border-t-transparent rounded-full animate-spin"></span>
                                        )}
                                        Document Inventory
                                    </button>
                                </div>
